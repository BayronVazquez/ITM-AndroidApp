...
public class Calendario extends AppCompatActivity {
    private final String calendarioURL = "http://www.matamoros.tecnm.mx/wp-content/uploads/Pdf-index/CALENDARIO_ESCOLAR_Agosto2020_Enero2021.pdf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.loadUrl("https://drive.google.com/viewerng/viewer?embedded=true&url=" + calendarioURL);
    }
/*
    @Override
...
*/
    ...
    public void ClickInfoTec(View view){ MainActivity.redirectActivity(this, InfoTec.class); }
